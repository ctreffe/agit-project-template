# Local Input Source Mapping

Copy this file to ignored `PATHS.local.md` and map stable logical external
locations to paths or endpoints available on this device.
