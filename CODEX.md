...
Codex must not use Git to modify repository history, staging state, branches,
tags or working tree contents.
...
These directories are local working artifacts and should normally be ignored by
Git.
